...
Atlas 0.1.2 is a static PWA that can be published with GitHub Pages. It does not require Node.js, a server, a paid database, or a build process.
...
Atlas 0.1.2 does not OCR PDF files. It also does not send extracted text into an AI system.
