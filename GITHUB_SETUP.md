...
That is expected in Atlas 0.1.2. Export a JSON backup on the original device and import it on the other device. Import replaces any existing Atlas records in the destination browser.
